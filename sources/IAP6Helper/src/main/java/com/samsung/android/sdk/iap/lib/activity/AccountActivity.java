...
public class AccountActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // ====================================================================
        LogUtil.i(TAG, "Samsung Account Login...");
    ...
    protected void onActivityResult(int _requestCode, int _resultCode, Intent intent) {
        LogUtil.i(TAG, "onActivityResult>> requestCode : " + _requestCode + ", resultCode : " + _resultCode);
        switch (_requestCode) {
            case HelperDefine.REQUEST_CODE_IS_ACCOUNT_CERTIFICATION:
                LogUtil.i(TAG, "REQUEST_CODE_IS_ACCOUNT_CERTIFICATION Result : " + _resultCode);
